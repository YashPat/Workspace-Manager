#!/usr/bin/env python3
"""
Personal Xcode Flow Script
Closes all GUI applications and opens a curated set of development tools (Chrome, GitHub Desktop, Cursor, Xcode).
"""
...
def open_and_maximize_apps():
    """
    Open and maximize configured development applications.
...
def main():
    ...
    1. Closes all GUI applications (except terminal and system apps)
    2. Opens and maximizes configured development applications
    """
    print("=" * 60)
    print("Personal Xcode Flow Script")
    print("=" * 60)
    print()
    
    close_all_gui_apps()
    open_and_maximize_apps()
